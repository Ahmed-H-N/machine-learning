...
import itertools # i think it is helpful to look at the documentation, there are funcs like permutations() and combinations() -> https://docs.python.org/3/library/itertools.html
